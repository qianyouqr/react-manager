	...
	const columns: ColumnsType<Role.RoleItem> = [
		...
		},
		{
			...
			render(_, record) {
				return (
					<Space>
						<AuthButton auth='role@edit' type='text' onClick={() => handleEdit(record)}>编辑</AuthButton>
						<AuthButton auth='role@auth' type='text' onClick={() => handleSetPermission(record)}>设置权限</AuthButton>
						<AuthButton auth='role@delete' type='text' onClick={() => handleDelete(record._id)} danger>删除</AuthButton>
		...
		<div className='role-wrap'>
			...
			<div className='base-table'>
				<div className='header-wrapper'>
					...
					<AuthButton auth='role@create' type='primary' onClick={handleCreate}>新增</AuthButton>
